...
//CSS
import styles from './EditCasas.module.css'

const EditCasas = () => {
  const {id} = useParams();
  const {document:casa} = useFetchDocument("casas",id)
    ...
    useEffect(() =>{
      ...
      if(casa){
        setTitle(casa.title);
        setCategory(casa.category);
        setImageOne(casa.imageOne);
        setImageTwo(casa.imageTwo);
        setImageThree(casa.imageThree);
        setImageFour(casa.imageFour);
        setImageFive(casa.imageFive);
        setImageSix(casa.imageSix);
        setBody(casa.body);
        setPrice(casa.price);
        setSize(casa.size);
        setMethod(casa.method);
        setCity(casa.city);
        setUf(casa.uf);
        setBedRooms(casa.bedRooms);
    ...
    const {updateDocument, response} = useUpdateDocument('casas'); //Enviar os dados para a coleção casas
  ...
  return (
    <div className={styles.create_product}>
      {casa && (
      <>
        <h2>Editando casa: {casa.title}</h2>
        <p>Altere os dados da casa.</p>
        <form onSubmit={handleSubmit} 
        action="">
          <div className={styles.containerPreviewImagesCasas}>
            <div>
              <p className={styles.preview_title}>Preview da imagem 1 atual:</p>
              <img 
            ...
            <div>
              <p className={styles.preview_title}>Preview da imagem 2 atual:</p>
              <img 
                className={styles.preview_image} 
                src={casa.imageTwo} 
                alt={casa.title} 
            ...
            <div>
              <p className={styles.preview_title}>Preview da imagem 3 atual:</p>
              <img 
                className={styles.preview_image} 
                src={casa.imageThree} 
                alt={casa.title} 
            ...
            <div>
              <p className={styles.preview_title}>Preview da imagem 4 atual:</p>
              <img 
                className={styles.preview_image} 
                src={casa.imageFour} 
                alt={casa.title} 
            ...
            <div>
              <p className={styles.preview_title}>Preview da imagem 5 atual:</p>
              <img 
                className={styles.preview_image} 
                src={casa.imageFive} 
                alt={casa.title} 
            ...
            <div>
              <p className={styles.preview_title}>Preview da imagem 6 atual:</p>
              <img 
                className={styles.preview_image} 
                src={casa.imageSix} 
                alt={casa.title} 
